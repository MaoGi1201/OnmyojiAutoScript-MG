...
class DemonEncounterAssets: 
	...
	# 极逢魔集结挑战 
	I_BEST_BOSS_FIRE = RuleImage(roi_front=(1086,562,100,36), roi_back=(1087,562,100,36), threshold=0.8, method="Template matching", file="./tasks/DemonEncounter/boss/boss_best_boss_fire.png")
	# 战斗失败-等待界面 
