...
class SecretAssets: 
	...
	# 秘闻挑战 
	I_SE_FIRE = RuleImage(roi_front=(1107,547,100,100), roi_back=(1107,547,100,100), threshold=0.7, method="Template matching", file="./tasks/Secret/se/se_se_fire.png")
	# 排行 
	I_SE_PLACEMENT = RuleImage(roi_front=(1014,567,50,48), roi_back=(996,555,79,81), threshold=0.8, method="Template matching", file="./tasks/Secret/se/se_se_placement.png")
	# 勾玉 
	I_SE_JADE = RuleImage(roi_front=(302,206,28,32), roi_back=(302,206,28,32), threshold=0.8, method="Template matching", file="./tasks/Secret/se/se_se_jade.png")
	# 最后一个的勾玉 
	...
	# Ocr Rule Assets
	# 未了 
	O_SE_NO_PASS = RuleOcr(roi=(428,151,262,248), area=(428,151,262,248), mode="Full", method="Default", keyword="未了", name="se_no_pass")
	# 第一个位置的层数 
	O_SE_LAYER_1 = RuleOcr(roi=(210,150,44,39), area=(210,150,44,39), mode="Single", method="Default", keyword="壹", name="se_layer_1")
	# Ocr-description 
	...
	# 后面的时候识别为通关的 
	O_SE_NO_PASS_LAST = RuleOcr(roi=(429,381,180,234), area=(429,381,180,234), mode="Full", method="Default", keyword="未開放", name="se_no_pass_last")
	# 勾玉 
	O_SE_JADE = RuleOcr(roi=(327,230,20,24), area=(327,230,20,24), mode="Digit", method="Default", keyword="", name="se_jade")
	# 金币 
	O_SE_GOLD = RuleOcr(roi=(363,236,48,21), area=(363,236,48,21), mode="Digit", method="Default", keyword="", name="se_gold")
	# 总耗时 
