...
class HyakkiyakouAssets: 
	...
	# 结束 
	I_HEND = RuleImage(roi_front=(79,165,86,300), roi_back=(79,165,86,300), threshold=0.8, method="Template matching", file="./tasks/Hyakkiyakou/hya/hya_hend.png")
	# 冰冻 
	...
	# Image Rule Assets
	# 好友 
	I_FRIEND_SAME_1 = RuleImage(roi_front=(348,124,82,48), roi_back=(348,124,82,48), threshold=0.8, method="Template matching", file="./tasks/Hyakkiyakou/hya/hya_friend_same_1.png")
	# 好友选中 
	I_FRIEND_SAME_2 = RuleImage(roi_front=(348,126,84,48), roi_back=(348,126,84,48), threshold=0.8, method="Template matching", file="./tasks/Hyakkiyakou/hya/hya_friend_same_2.png")
	# 回归活动使用 
	I_FRIEND_SAME_1_RECALL = RuleImage(roi_front=(140,124,82,48), roi_back=(140,124,82,48), threshold=0.8, method="Template matching", file="./tasks/Hyakkiyakou/hya/hya_friend_same_1.png")
	# 回归活动使用 
	I_FRIEND_SAME_2_RECALL = RuleImage(roi_front=(140,126,84,48), roi_back=(140,126,84,48), threshold=0.8, method="Template matching", file="./tasks/Hyakkiyakou/hya/hya_friend_same_2.png")
	# 回归活动使用 
	I_FRIEND_RYOU_1_RECALL = RuleImage(roi_front=(326,124,84,48), roi_back=(269,106,159,91), threshold=0.8, method="Template matching", file="./tasks/Hyakkiyakou/hya/hya_friend_ryou_1.png")
	# 回归活动使用 
	I_FRIEND_RYOU_2_RECALL = RuleImage(roi_front=(326,126,84,46), roi_back=(326,126,84,46), threshold=0.8, method="Template matching", file="./tasks/Hyakkiyakou/hya/hya_friend_ryou_2.png")
	# 寮友 
	...
	# 判断是否进入邀请页面 
	I_CHECK_INVITATION = RuleImage(roi_front=(424,140,264,54), roi_back=(308,113,826,100), threshold=0.8, method="Template matching", file="./tasks/Hyakkiyakou/hya/hya_check_invitation.png")
