...
class SoulsTidyAssets: 
	...
	# 奉纳 
	I_ST_DONATE = RuleImage(roi_front=(811,628,130,70), roi_back=(811,628,130,70), threshold=0.8, method="Template matching", file="./tasks/SoulsTidy/simple/simple_st_donate.png")
	# 神赐 
	...
	# 已弃置被选中 
	I_ST_ABANDONED_SELECTED = RuleImage(roi_front=(31,114,106,48), roi_back=(31,114,106,48), threshold=0.7, method="Template matching", file="./tasks/SoulsTidy/simple/simple_st_abandoned_selected.png")
	# 第一个御魂是+0的 
