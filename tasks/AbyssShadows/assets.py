...
class AbyssShadowsAssets: 
	...
	# 黑豹领域 
	I_LEOPARD_AREA = RuleImage(roi_front=(589,14,104,39), roi_back=(589,1,104,39), threshold=0.8, method="Template matching", file="./tasks/AbyssShadows/res/res_leopard_area.png")
	# 白藏主领域 
