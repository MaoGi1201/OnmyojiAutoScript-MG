...
class AbyssShadowsAssets: 
	...
	# 孔雀暗域 
	I_PEACOCK_AREA = RuleImage(roi_front=(577,15,127,36), roi_back=(577,14,127,36), threshold=0.8, method="Template matching", file="./tasks/AbyssShadows/res/res_peacock_area.png")
	# 黑豹领域 
	I_LEOPARD_AREA = RuleImage(roi_front=(589,14,104,39), roi_back=(589,13,104,39), threshold=0.8, method="Template matching", file="./tasks/AbyssShadows/res/res_leopard_area.png")
	# 白藏主领域 
	I_FOX_AREA = RuleImage(roi_front=(581,19,121,29), roi_back=(581,18,121,29), threshold=0.8, method="Template matching", file="./tasks/AbyssShadows/res/res_fox_area.png")
	# 更换领域 
	...
	# 神龙领域 
	I_DRAGON_AREA = RuleImage(roi_front=(582,14,112,34), roi_back=(582,13,112,34), threshold=0.8, method="Template matching", file="./tasks/AbyssShadows/res/res_dragon_area.png")
	# 集结中 
	I_WAIT_TO_START = RuleImage(roi_front=(586,66,70,26), roi_back=(586,65,70,26), threshold=0.8, method="Template matching", file="./tasks/AbyssShadows/res/res_wait_to_start.png")
	# 准备 
