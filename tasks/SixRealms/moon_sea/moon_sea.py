...
class MoonSea(MoonSeaMap, MoonSeaL101, MoonSeaL102, MoonSeaL103, MoonSeaL104, MoonSeaL105):
    ...
    def boss_battle(self) -> bool:
        ...
        if self.wait_until_appear(self.I_BOSS_SHUTU_SUPER, wait_time=10):
            self.ui_click(self.I_BOSS_SHUTU_SUPER, stop=self.I_MSTART)
        elif  self.wait_until_appear(self.I_BOSS_SHUTU_SIMPLE, wait_time=10):
            self.ui_click(self.I_BOSS_SHUTU_SIMPLE, stop=self.I_MSTART)
        return True
