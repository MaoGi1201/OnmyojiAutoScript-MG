...
class DailyTriflesAssets: 
	...
	# description 
	I_GIFT_RECOMMEND = RuleImage(roi_front=(1184,225,46,56), roi_back=(1172,102,83,306), threshold=0.8, method="Template matching", file="./tasks/DailyTrifles/store/store_gift_recommend.png")
	# 免费黑蛋 
