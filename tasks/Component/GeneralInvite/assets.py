...
class GeneralInviteAssets: 
	...
	# 左上角退出 
	I_BACK_YELLOW = RuleImage(roi_front=(19,14,58,55), roi_back=(19,14,58,55), threshold=0.8, method="Template matching", file="./tasks/Component/GeneralInvite/gi/gi_back_yellow.png")
	# 点击邀请 
