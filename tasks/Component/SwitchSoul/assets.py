...
class SwitchSoulAssets: 
	...
	# 预设 
	I_SOUL_PRESET = RuleImage(roi_front=(329,68,96,54), roi_back=(310,57,169,72), threshold=0.8, method="Template matching", file="./tasks/Component/SwitchSoul/ss/ss_soul_preset.png")
	# description 
